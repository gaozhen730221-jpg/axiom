...
def fetch_realmarket_light(code):
    ...
    stock_info = database.get(clean_code, {
        ...
        "detail": "當前盤中大單買賣力道均衡，籌碼並未向特定外資分點集中，量能持平，大數據核心建議靜待籌碼流速再次放大。"
    })
...
st.markdown("""
    ...
    /* 核心修正：強制輸入框與白字提示（Placeholder）高亮、字體縮小 */
    ...
    /* 暴力覆蓋所有瀏覽器的 Placeholder 顏色為 100% 純白色 */
    .stTextInput>div>div>input::placeholder { color: #FFFFFF !important; opacity: 1 !important; font-size: 1.05rem !important; }
    .stTextInput>div>div>input::-webkit-input-placeholder { color: #FFFFFF !important; opacity: 1 !important; font-size: 1.05rem !important; }
    .stTextInput>div>div>input::-moz-placeholder { color: #FFFFFF !important; opacity: 1 !important; font-size: 1.05rem !important; }
    .stTextInput>div>div>input:-ms-input-placeholder { color: #FFFFFF !important; opacity: 1 !important; font-size: 1.05rem !important; }
